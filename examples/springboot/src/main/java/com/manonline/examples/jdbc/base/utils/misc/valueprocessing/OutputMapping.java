...
public class OutputMapping {
    ...
    static void queryMetaData(String sql, Object[] params)  {
        Connection conn = null;
        ...
        try {
            ...
            ConnectionUtils.free(null, ps, conn);
        }
    }

    static void resultSetMetaData(String sql)  {
        Connection conn = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
        try {
